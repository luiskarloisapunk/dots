...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(253, 254, 253, 0.07)"}, angle = 45 },
            inactive_border = "rgba(253, 254, 253, 0.01)",
        },
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1.04, bezier = "almostLinear", style = "slidevert" })
